  ...
  methods: {
    addComment: function addComment() {
      ...
      axios.post("/api/comments/", this.formData).then(function (response) {
        ...
        _this2.formData.text = ""; //mostro messaggio di avviso che il commento e' stato inserito
...
// module
exports.push([module.i, ".category[data-v-5604aa65] {\n  width: 100%;\n  background: #fff;\n}\n.category .title[data-v-5604aa65] {\n  font-size: 2.25rem;\n  font-weight: bold;\n  padding: 5px;\n}", ""]);
...
var render = function () {
  ...
  return _c(
    ...
    _vm._l(_vm.posts, function (post) {
      return _c(
        "div",
        { key: post.id, staticClass: "mt-5" },
        [
          _c("ul", [
            _c("li", [_vm._v("ID: " + _vm._s(post.id))]),
            _vm._v(" "),
            _c("li", [_vm._v("Title: " + _vm._s(post.title))]),
            _vm._v(" "),
            _c("li", [_vm._v("Content: " + _vm._s(post.content))]),
            _vm._v(" "),
            post.category
              ? _c("li", [_vm._v("Category: " + _vm._s(post.category.name))])
              : _vm._e(),
            _vm._v(" "),
            _c("li", [
              _vm._v("Tag:\n                "),
...
var staticRenderFns = [
  function () {
    ...
    return _c("div", [
      ...
      _c("p", [
        _vm._v(
          "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea eveniet explicabo assumenda. Sunt necessitatibus repudiandae distinctio exercitationem suscipit, nisi atque unde dignissimos autem eaque facere pariatur dolores facilis minus. Mollitia?"
        ),
      ]),
    ])
  },
      ...
      _c(
        ...
        [
          ...
          _vm.formErrors.content
            ? _c("div", { staticStyle: { background: "red, color: white" } }, [
                _c(
                  "ul",
...
module.exports = __webpack_require__(/*! C:\Users\Davide\Desktop\Boolean\laravel-boolpress\resources\js\front.js */"./resources/js/front.js");
